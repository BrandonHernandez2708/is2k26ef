...
INSERT INTO `clientes` VALUES (1,'brandon','40472324','bhernandez@gmail.com');
...
INSERT INTO `cursos` VALUES ('1','Algebra','1'),('3','Naturales','1');
...
INSERT INTO `pedidos` VALUES (1,'2026-05-27',100.00,1);
...
INSERT INTO `tbl_asignacion_clientes` VALUES (1,1),(1,2),(1,3),(1,4);
...
INSERT INTO `tbl_clientes` VALUES (1,'96459641964','armando ','Barrera','61616161','armando@mail.com',118456,'zona 2',1,'Activo'),(2,'334344','Ruben','luch','3434344','rlopez@mail.com',119188,'zona 2',1,'Activo'),(3,'343443','Maria','Zardoya','61616161','themarias@mail.com',222,'zona 2',1,'Activo'),(4,'3434343434342','vinicio','Montenegro','2445532','vini@mail.com',0,'zona 4',1,'Activo');
...
CREATE TABLE `tbl_comprobante_compra` (
  ...
  KEY `Fk_ID_Proveedor` (`Fk_ID_Proveedor`),
  CONSTRAINT `fk_comprobante_compra_entrega` FOREIGN KEY (`Fk_ID_Entrega_Compra`) REFERENCES `tbl_entrega_compra` (`Pk_Id_Entrega_Compra`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_comprobante_compra_proveedor` FOREIGN KEY (`Fk_ID_Proveedor`) REFERENCES `tbl_proveedores` (`pk_id_proveedor`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_comprobante_compra` VALUES (1,1,1,'Carlos Rupen','2026-05-28 08:07:08','Observación','Entregado');
...
INSERT INTO `tbl_cuentas_por_cobrar` VALUES (1,2,1,'2026-04-30 23:38:02','2026-05-30 23:38:02',18.5,'Inactivo'),(2,5,1,'2026-04-30 23:38:02','2026-05-30 23:38:02',90,'Inactivo'),(3,9,1,'2026-04-30 23:38:02','2026-05-30 23:38:02',56,'Inactivo'),(4,10,1,'2026-05-01 00:00:00','2026-05-31 00:00:00',1400,'Inactivo'),(5,11,1,'2026-05-01 00:00:00','2026-05-31 00:00:00',22500,'Inactivo'),(6,12,1,'2026-05-01 00:00:00','2026-05-31 00:00:00',40500,'Inactivo'),(7,13,1,'2026-05-01 00:00:00','2026-05-31 00:00:00',27000,'Inactivo'),(8,14,1,'2026-05-01 00:00:00','2026-05-31 00:00:00',27000,'Inactivo'),(9,15,2,'2026-05-01 00:00:00','2026-05-31 00:00:00',0,'Inactivo'),(10,16,1,'2026-05-01 00:00:00','2026-05-31 00:00:00',45,'Inactivo'),(11,17,2,'2026-05-01 00:00:00','2026-05-31 00:00:00',32,'Activo'),(12,18,1,'2026-05-01 00:00:00','2026-05-31 00:00:00',18.5,'Inactivo'),(13,19,2,'2026-05-08 00:00:00','2026-06-07 00:00:00',700,'Activo'),(14,21,3,'2026-01-01 00:00:00','2026-01-31 00:00:00',45,'Activo'),(15,22,3,'2026-03-03 00:00:00','2026-04-02 00:00:00',45,'Activo'),(16,23,3,'2026-02-02 00:00:00','2026-03-04 00:00:00',42,'Activo'),(17,24,3,'2026-05-13 00:00:00','2026-06-12 00:00:00',90,'Activo');
...
INSERT INTO `tbl_cuentas_por_cobrar_detalle` VALUES (1,9,5,'RCP-20260507-I9A0NP','2026-05-07',45,0),(2,10,5,'RCP-20260507-RR3NJB','2026-05-07',45,0),(3,12,1,'VHC-20260508-KD99OK','2026-05-08',18.5,0);
...
CREATE TABLE `tbl_cuentas_por_pagar_detalle` (
  ...
  `cmp_anulado` tinyint NOT NULL DEFAULT '0',
  `fk_id_detalle_compra` int DEFAULT NULL,
  PRIMARY KEY (`pk_id_cuenta_por_pagar_detalle`),
  KEY `fk_id_cuenta_por_pagar` (`fk_id_cuenta_por_pagar`),
  KEY `fk_cxp_detalle_compra` (`fk_id_detalle_compra`),
  CONSTRAINT `fk_cxp_detalle_compra` FOREIGN KEY (`fk_id_detalle_compra`) REFERENCES `tbl_detalle_compra` (`pk_id_detalle_compra`),
...
INSERT INTO `tbl_cuentas_por_pagar_detalle` VALUES (1,3002,'abono','AB-001','2026-04-10',300,550,0,NULL),(2,3003,'pago_total','PG-001','2026-04-10',2300,0,0,NULL),(3,3001,'abono','123131','2026-04-28',443,1057,0,NULL),(4,3004,'abono','PAGO-CXP-20260428094318','2026-04-28',200,3000,0,NULL),(5,3004,'pago_total','PAGO-CXP-20260428094442','2026-04-28',3000,0,0,NULL),(6,3001,'abono','PAGO-CXP-20260428094509','2026-04-28',100,957,0,NULL);
...
--
-- Table structure for table `tbl_detalle_devolucion_ventas`
--

DROP TABLE IF EXISTS `tbl_detalle_devolucion_ventas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_detalle_devolucion_ventas` (
  `Fk_Id_Devolucion_Ventas` int NOT NULL,
  `Fk_Id_Inventario` int NOT NULL,
  `Cmp_Cantidad_Producto` float NOT NULL,
  `Cmp_Precio_Subtotal` float NOT NULL,
  PRIMARY KEY (`Fk_Id_Devolucion_Ventas`,`Fk_Id_Inventario`),
  KEY `Fk_Id_Inventario` (`Fk_Id_Inventario`),
  CONSTRAINT `fk_detalle_devolucion` FOREIGN KEY (`Fk_Id_Devolucion_Ventas`) REFERENCES `tbl_devolucion_ventas` (`Pk_Id_Devolucion_Ventas`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_detalle_devolucion_inventario` FOREIGN KEY (`Fk_Id_Inventario`) REFERENCES `tbl_inventario` (`pk_inventario_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_detalle_devolucion_ventas`
--

LOCK TABLES `tbl_detalle_devolucion_ventas` WRITE;
/*!40000 ALTER TABLE `tbl_detalle_devolucion_ventas` DISABLE KEYS */;
INSERT INTO `tbl_detalle_devolucion_ventas` VALUES (1,1,1,18.5);
/*!40000 ALTER TABLE `tbl_detalle_devolucion_ventas` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tbl_detalle_orden_compra` VALUES (1,5,2,1,12,10.00),(2,6,3,1,500,45.00);
...
INSERT INTO `tbl_detalle_ventas` VALUES (2,1,1,18.5,0),(3,2,1,14,0),(4,2,1,14,0),(5,3,2,90,0),(6,4,2,64,0),(7,4,2,64,0),(8,5,1,28,0),(9,5,2,56,0),(10,2,100,1400,0),(11,3,500,22500,0),(12,3,900,40500,0),(13,3,600,27000,0),(14,3,600,27000,0),(15,3,1,45,0),(16,3,1,45,0),(17,4,1,32,0),(18,1,1,18.5,0),(19,2,50,700,0),(20,3,45,2025,0),(21,3,1,45,0),(22,3,1,45,0),(23,2,3,42,0),(24,3,2,90,0),(25,6,15,3000,0),(25,7,100,50000,0),(25,8,10,500,0),(26,6,15,3000,0),(26,7,100,50000,0),(26,8,10,500,0),(27,6,15,3000,0),(27,7,100,50000,0),(27,8,10,500,0),(28,6,15,3000,0),(28,7,100,50000,0),(28,8,10,500,0),(29,6,15,3000,0),(29,7,100,50000,0),(29,8,10,500,0),(30,6,15,3000,0),(30,7,100,50000,0),(30,8,10,500,0);
/*!40000 ALTER TABLE `tbl_detalle_ventas` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tbl_devolucion_ventas`
--

DROP TABLE IF EXISTS `tbl_devolucion_ventas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_devolucion_ventas` (
  `Pk_Id_Devolucion_Ventas` int NOT NULL AUTO_INCREMENT,
  `Fk_Id_Venta` int NOT NULL,
  `Cmp_Fecha_Devolucion` datetime NOT NULL,
  `Cmp_Motivo` varchar(255) DEFAULT NULL,
  `Cmp_Saldo_Total` decimal(10,2) NOT NULL,
  `Cmp_Estado` enum('Activo','Inactivo') DEFAULT 'Activo',
  PRIMARY KEY (`Pk_Id_Devolucion_Ventas`),
  KEY `Fk_Id_Venta` (`Fk_Id_Venta`),
  CONSTRAINT `fk_devolucion_venta` FOREIGN KEY (`Fk_Id_Venta`) REFERENCES `tbl_ventas` (`Pk_Id_Ventas`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_devolucion_ventas`
--

LOCK TABLES `tbl_devolucion_ventas` WRITE;
/*!40000 ALTER TABLE `tbl_devolucion_ventas` DISABLE KEYS */;
INSERT INTO `tbl_devolucion_ventas` VALUES (1,2,'2026-05-16 10:30:00','Producto defectuoso',18.50,'');
/*!40000 ALTER TABLE `tbl_devolucion_ventas` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tbl_devoluciones_detalle` (
  ...
  `fk_inventario_id` int NOT NULL,
  `cmp_cantidad_devuelta` float NOT NULL,
...
INSERT INTO `tbl_devoluciones_detalle` VALUES (1,5,1,1,2,12.23,24.46,'Devolución parcial registrada desde el formulario.');
...
INSERT INTO `tbl_empresa_transporte` VALUES (1,'FedEx','9999999','correogamail.com','ACTIVO');
...
INSERT INTO `tbl_entrega_compra` VALUES (1,2001,1,'CUM','2026-05-15 00:00:00','Entregado');
...
INSERT INTO `tbl_existencias` VALUES (1,1,149,NULL,1,3),(2,1,47,NULL,1,3),(2,4,300,NULL,1,2),(3,2,0,NULL,2,4),(3,3,316,45,1,4),(4,3,79,NULL,1,4),(5,4,0,98,1,2),(5,6,400,NULL,1,2),(6,1,125,15,1,1),(7,1,0,100,2,1),(8,1,0,10,2,1),(9,1,100,0,1,1),(10,1,20,0,1,1),(11,1,15,0,1,1);
...
INSERT INTO `tbl_inventario` VALUES (1,1,3,'Leche entera 1L','Leche entera pasteurizada Lala',18.5,'PF','ACTIVO'),(2,2,2,'Coca-Cola 600ml','Refresco carbonatado sabor cola',14,'PF','ACTIVO'),(3,3,1,'Arroz 5kg','Arroz blanco grano largo Nestlé',45,'MP','ACTIVO'),(4,4,4,'Ariel 1kg','Detergente en polvo con aroma',32,'PF','ACTIVO'),(5,5,5,'Pan blanco','Pan de caja blanco Bimbo 680g',28,'PF','ACTIVO'),(6,1,1,'Plywood 15mm','Plancha de plywood de 15mm para muebles',200,'MP','ACTIVO'),(7,1,1,'Clavos 2 pulgadas','Clavos de acero de 2 pulgadas',500,'MP','ACTIVO'),(8,1,1,'Pegamento Blanco','Pegamento blanco para madera',50,'MP','ACTIVO'),(9,1,1,'Lija 120','Lija fina para acabado',100,'MP','ACTIVO'),(10,1,1,'Silla Ejecutiva','Silla de madera tapizada',20,'PF','ACTIVO'),(11,1,1,'Mesa de Centro','Mesa de centro de madera',15,'PF','ACTIVO');
...
INSERT INTO `tbl_movimiento_inventario_detalle` VALUES (1,1,50,0),(2,2,30,0),(3,3,100,0),(4,4,10,0),(5,5,5,0),(6,3,3,0),(6,4,5,0),(7,2,6,0),(7,3,2,0),(10,3,500,0),(11,2,100,0),(12,3,500,0),(13,3,900,0),(14,3,600,0),(15,3,600,0),(16,3,600,0),(17,4,900,0),(18,4,900,0),(19,4,900,0),(20,4,900,0),(21,3,300,0),(21,4,900,0),(22,4,600,0),(23,4,600,0),(24,4,600,0),(25,4,600,0),(26,2,600,0),(27,5,22,0),(29,3,153,0),(29,5,98,0),(30,3,1,0),(31,3,1,0),(32,4,1,0),(33,1,1,0),(34,2,50,0),(35,3,45,0),(36,3,1,0),(37,3,1,0),(38,2,3,0),(39,3,2,0),(40,3,10,3),(41,2,300,4),(41,3,10,3),(41,5,400,6),(43,6,15,1),(43,7,100,1),(43,8,10,1),(44,6,15,1),(44,7,100,1),(44,8,10,1),(45,6,15,1),(45,7,100,1),(45,8,10,1),(46,6,15,1),(46,7,100,1),(46,8,10,1),(47,6,15,1),(47,7,100,1),(47,8,10,1);
...
INSERT INTO `tbl_movimiento_inventario_encabezado` VALUES (1,1,'2025-01-10 08:00:00','Compra inicial de inventario'),(2,2,'2025-01-11 10:30:00','Venta a cliente mayorista'),(3,1,'2025-01-12 09:15:00','Reabastecimiento bodega norte'),(4,3,'2025-01-13 14:00:00','Devolución de producto dañado'),(5,5,'2025-01-14 16:45:00','Ajuste por merma'),(6,4,'2026-04-21 09:07:34','Inserción'),(7,3,'2026-04-21 09:35:07','Descripcion'),(10,2,'2026-04-28 10:03:32','movimiento'),(11,3,'2026-05-01 00:00:00','Venta'),(12,3,'2026-05-01 00:00:00','Venta'),(13,3,'2026-05-01 00:00:00','Venta'),(14,3,'2026-05-01 00:00:00','Venta'),(15,3,'2026-05-01 00:00:00','Venta'),(16,3,'2026-05-01 00:00:00','Venta'),(17,1,'2026-05-05 20:22:43','Apartado'),(18,1,'2026-05-05 20:22:43','Apartado'),(19,1,'2026-05-05 20:22:43','Apartado'),(20,1,'2026-05-05 20:22:43','Apartado'),(21,2,'2026-05-21 20:22:43','Apartado'),(22,2,'2026-05-05 20:31:21','Apartado'),(23,2,'2026-05-05 20:31:21','Apartado'),(24,2,'2026-05-05 20:31:21','Apartado'),(25,2,'2026-05-05 20:31:21','Apartado'),(26,2,'2026-05-05 20:35:44','prueba apartado'),(27,2,'2026-05-05 20:44:18','Prueba entrada 8:45'),(29,2,'2026-05-05 00:00:00','prueba apartado'),(30,3,'2026-05-01 00:00:00','Venta'),(31,3,'2026-05-01 00:00:00','Venta'),(32,3,'2026-05-01 00:00:00','Venta'),(33,3,'2026-05-01 00:00:00','Venta'),(34,3,'2026-05-08 00:00:00','Venta'),(35,3,'2026-05-08 00:00:00','Venta'),(36,3,'2026-01-01 00:00:00','Venta'),(37,3,'2026-03-03 00:00:00','Venta'),(38,3,'2026-02-02 00:00:00','Venta'),(39,3,'2026-05-13 00:00:00','Venta'),(40,2,'2026-05-14 08:15:11','Prueba CARGAR DGV'),(41,2,'2026-05-14 08:15:11','Prueba CARGAR DGV 2'),(43,3,'2026-05-08 00:00:00','Venta'),(44,3,'2026-05-08 00:00:00','Venta'),(45,3,'2026-05-08 00:00:00','Venta'),(46,3,'2026-05-08 00:00:00','Venta'),(47,3,'2026-05-27 00:00:00','Venta');
/*!40000 ALTER TABLE `tbl_movimiento_inventario_encabezado` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tbl_nivel_stock`
--

DROP TABLE IF EXISTS `tbl_nivel_stock`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_nivel_stock` (
  `pk_nivel_id` int NOT NULL AUTO_INCREMENT,
  `nombre_nivel` varchar(50) NOT NULL,
  `stock_minimo` int NOT NULL,
  `stock_maximo` int NOT NULL,
  `color_hex` varchar(10) DEFAULT NULL,
  `estado` enum('Activo','Inactivo') NOT NULL DEFAULT 'Activo',
  PRIMARY KEY (`pk_nivel_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_nivel_stock`
--

LOCK TABLES `tbl_nivel_stock` WRITE;
/*!40000 ALTER TABLE `tbl_nivel_stock` DISABLE KEYS */;
INSERT INTO `tbl_nivel_stock` VALUES (1,'SIN STOCK',0,0,'#FFCDD2','Activo'),(2,'CRÍTICO',1,80,'#FFE0B2','Activo'),(3,'BAJO',81,150,'#FFF9C4','Activo'),(4,'MEDIO',151,300,'#C8E6C9','Activo'),(5,'ALTO',301,9999,'#BBDEFB','Activo');
/*!40000 ALTER TABLE `tbl_nivel_stock` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tbl_orden_produccion_detalle` VALUES (1,1,3,500,100);
...
INSERT INTO `tbl_orden_produccion_encabezado` VALUES (1,1,'2026-05-27','Emitida','2026-05-27');
...
INSERT INTO `tbl_tipo_transporte` VALUES (1,1,'Camion','DTV994','Juan',12,'Disponible');
...
INSERT INTO `tbl_unidad_de_medida` VALUES (1,'Galon','GL','Galon','Activo'),(2,'Libra','LB','Libra','Activo'),(3,'Litro','LT','Litro','Activo'),(4,'Kilogramo','KG','Kilogramo','Activo'),(1010,'ProductoFinal','PF','Producto terminado','Activo');
...
INSERT INTO `tbl_usuario` VALUES (4,2,'brandon','45297c633d331e6ac35169ebaaf75bc7fafd206ebb59ba4efd80566936e46eb0',0,_binary '','2025-09-21 20:49:54','2025-10-18 17:09:11',_binary '\0'),(23,3,'admin','240be518fabd2724ddb6f04eeb1da5967448d7e831c08c8fa822809f74c720a9',0,_binary '','2025-09-26 20:45:53','2025-09-26 20:45:53',_binary '\0'),(64,2,'UsuarioFinal','a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3',0,_binary '','2026-05-28 10:48:53','2026-05-28 10:48:53',_binary '\0');
...
INSERT INTO `tbl_usuario_perfil` VALUES (4,1),(64,1);
...
CREATE TABLE `tbl_ventas` (
  ...
  `Cmp_Fecha_Vencimiento` datetime DEFAULT NULL,
  `Cmp_Fecha_Entrega` datetime DEFAULT NULL,
  `Fk_Id_Orden_Material_MRP` int DEFAULT NULL,
...
INSERT INTO `tbl_ventas` VALUES (2,'2026-04-30 23:38:02',1,1,'Activo',18.5,'Venta',NULL,NULL,NULL),(3,'2026-04-24 23:38:02',1,1,'Activo',14,'Cotizacion',NULL,NULL,NULL),(4,'2026-04-30 23:38:02',1,1,'Activo',14,'Cotizacion',NULL,NULL,NULL),(5,'2026-04-30 23:38:02',1,1,'Activo',90,'Venta',NULL,NULL,NULL),(6,'2026-04-30 23:38:02',1,1,'Activo',64,'Cotizacion',NULL,'2026-05-02 23:38:02',NULL),(7,'2026-04-30 23:38:02',1,1,'Activo',64,'Cotizacion','2026-10-16 23:38:02',NULL,NULL),(8,'2026-04-30 23:38:02',1,1,'Activo',28,'Pedido',NULL,'2026-10-16 23:38:02',NULL),(9,'2026-04-30 23:38:02',1,1,'Activo',56,'Venta',NULL,NULL,NULL),(10,'2026-05-01 00:00:00',1,1,'Activo',1400,'Venta',NULL,NULL,NULL),(11,'2026-05-01 00:00:00',1,1,'Activo',22500,'Venta',NULL,NULL,NULL),(12,'2026-05-01 00:00:00',1,1,'Activo',40500,'Venta',NULL,NULL,NULL),(13,'2026-05-01 00:00:00',1,1,'Activo',27000,'Venta',NULL,NULL,NULL),(14,'2026-05-01 00:00:00',1,1,'Activo',27000,'Venta',NULL,NULL,NULL),(15,'2026-05-01 00:00:00',2,1,'0',45,'Venta',NULL,NULL,NULL),(16,'2026-05-01 00:00:00',1,1,'0',45,'Venta',NULL,NULL,NULL),(17,'2026-05-01 00:00:00',2,1,'0',32,'Venta',NULL,NULL,NULL),(18,'2026-05-01 00:00:00',1,1,'0',18.5,'Venta',NULL,NULL,NULL),(19,'2026-05-08 00:00:00',2,1,'0',700,'Venta',NULL,NULL,NULL),(20,'2026-05-08 00:00:00',1,1,'0',2025,'Pedido',NULL,'2026-05-15 00:00:00',NULL),(21,'2026-01-01 00:00:00',3,1,'0',45,'Venta',NULL,NULL,NULL),(22,'2026-03-03 00:00:00',3,1,'0',45,'Venta',NULL,NULL,NULL),(23,'2026-02-02 00:00:00',3,1,'0',42,'Venta',NULL,NULL,NULL),(24,'2026-05-13 00:00:00',3,1,'0',90,'Venta',NULL,NULL,NULL),(25,'2026-05-08 00:00:00',1,1,'Activo',53500,'Pedido',NULL,'2026-05-08 00:00:00',600),(26,'2026-05-08 00:00:00',1,1,'Activo',53500,'Pedido',NULL,'2026-05-08 00:00:00',600),(27,'2026-05-08 00:00:00',1,1,'Activo',53500,'Pedido',NULL,'2026-05-08 00:00:00',600),(28,'2026-05-08 00:00:00',1,1,'Activo',53500,'Pedido',NULL,'2026-05-08 00:00:00',600),(29,'2026-05-08 00:00:00',1,1,'Activo',53500,'Pedido',NULL,'2026-05-08 00:00:00',600),(30,'2026-05-27 00:00:00',1,1,'Activo',53500,'Pedido',NULL,'2026-05-27 00:00:00',625);
...
-- Dump completed on 2026-05-28 11:10:47
